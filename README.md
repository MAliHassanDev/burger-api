...
-   🔄 **Middleware Architecture:**  
    Supports both global and route-specific middleware with a familiar
...
-   🛠️ **Request & Response Enhancements:**
    ...
    -   `BurgerRequest` extends the native Request to include query, params, and
        validated data.
    -   `BurgerResponse` provides methods to set headers, status, and build
...
Stay tuned for updates as we continue to build and improve burger-api! We're
...
-   🔄 **How do I add custom middleware?**  
    You can pass an array of global middleware in the Burger options or export
...
-   ✅ **How is validation handled?**  
    burger-api uses Zod for schema validation. Define your schemas in your route
...
_burger-api_ aims to revolutionize your API development experience with
