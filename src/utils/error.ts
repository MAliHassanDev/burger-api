...
export function errorResponse(
  ...
  if (acceptHeader.includes("text/html") && debug) {
    const body = `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Error Occurred - BurgerAPI</title>
            <style>
                body {
                    margin: 0;
                    padding: 0;
                ...
                .whoops-header .debug-mode .fa-check-circle {
            ...
            <div class="whoops-container">
                <div class="whoops-header">
                    ...
                    <div class="debug-mode">
                        <i class="fas fa-check-circle"></i> Debug Mode Enabled
                    </div>
                </div>
